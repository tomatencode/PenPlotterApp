...
export function documentToGcode(doc: PnplttrDocument, onProgress?: ProgressCallback): string {
  ...
  for (let i = 0; i < batchCount; i++) {
    ...
    const strokes = runAco(raw, home, {maxTimeMs: 15000, alpha: 1, beta: 4, rho: 0.12, candidateListSize: 30, minUniqueStrokesInDecision: 5, numAnts: 50, stagnationThreshold: 0.9, maxStagnationResets: 7});
